...
const { MSG_QUEUE_URL, EXCHANGE_NAME, QUEUE_NAME, DISCUSSION_BINDING_KEY } = require('../config/env');
...
module.exports.SubscribeMessage = async (channel, service) => {
    try {
        ...
        channel.bindQueue(queue.queue, EXCHANGE_NAME, DISCUSSION_BINDING_KEY);
